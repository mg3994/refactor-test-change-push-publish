...
(function() {
  ...
  function bootstrap() {
    ...
    App.Registry = {
      ...
      validateCoupon: new ValidateCouponUseCase(r.Coupons),
      createOrder: new CreateOrderUseCase(r.Products, r.Orders, r.Coupons, utils),
      ...
      getProducts: new GetProductsUseCase(r.Products, s.ProductQuery, utils),
      getCategories: new GetCategoriesUseCase(r.Categories),
      addReview: new AddReviewUseCase(r.Reviews),
      getCartPreview: new GetCartPreviewUseCase(r.Products, r.Coupons, utils),
      getReviews: new GetReviewsUseCase(r.Reviews, r.Orders, utils),
      searchProducts: new SearchProductsUseCase(r.Products, s.ProductQuery, utils),
      getProfile: new GetProfileUseCase(r.Profiles),
      updateProfile: new UpdateProfileUseCase(r.Profiles, utils),
      toggleWishlist: new ToggleWishlistUseCase(r.Wishlists, utils),
      getWishlist: new GetWishlistUseCase(r.Wishlists, r.Products, s.ProductQuery),
      getRelatedProducts: new GetRelatedProductsUseCase(r.Products, s.ProductQuery),
